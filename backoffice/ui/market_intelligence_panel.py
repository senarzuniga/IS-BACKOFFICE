        ...
        class MarketIntelligencePanel:
            ...
            def _tab_market(self) -> None:
                ...
                if rows:
                    ...
                    st.dataframe(df_prod, height=350)
            ...
            def _tab_content(self) -> None:
                ...
                with col1:
                    type_filter = st.selectbox(
                        "Tipo", ["", "news", "blog", "trend", "review", "report", "general"], key="content_type",
                    )
                with col2:
            ...
            def _tab_reports(self) -> None:
                ...
                if sessions:
                    ...
                    st.dataframe(_df(sessions, ["task_type", "query", "status", "created_at"]))
